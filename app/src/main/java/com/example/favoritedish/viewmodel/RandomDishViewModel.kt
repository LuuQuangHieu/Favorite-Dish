...
import com.example.favoritedish.model.network.RandomDishApiService
...
class RandomDishViewModel: ViewModel() {
    ...
    /**
     * A disposable container that can hold onto multiple other Disposables and offers time
     * complexity for add(Disposable), remove(Disposable) and delete(Disposable) operations.
     */
    ...
    //function to initialize all the instance and set the observers to it
    fun getRandomRecipeFromAPI(){
        //define the value of the load random dish
        loadRandomDish.value = true

        //add a Disposable to this container of disposes it if the container has been disposed.
